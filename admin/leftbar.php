<section class="leftbar">
	...
	<ul class="list-nav">
		...
		<a href="dashboard.php"><li class="list-nav-item active"><i class="fas fa-user-plus"></i> CEO Data</li></a>
		<a href="addcan.php"><li class="list-nav-item"><i class="fas fa-user-plus"></i> Add Employee</li></a>
