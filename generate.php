						...
						<div class="col-lg-6">
							<div class="signintext">
								...
								<div class="login-agent pt-3" id="login-agent">
									...
									<p>Khap Software Solutions &copy; <?php echo date('Y');?> | <span class="forgentpass" id="forgentpass">Forget Password </span></p>
								...
								<div class="forget-password pt-3" id="forget-password">
									...
									<p>Khap Software Solutions &copy; <?php echo date('Y');?> | <span class="forgentpass" id="agentlog">Login </span></p>
								</div>
								<?php
